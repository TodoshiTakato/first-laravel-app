        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="team-member">
                        <div class="thumb-container">
                            <img src="{{ asset('assets/images/team_05.jpg')}}" alt="">
                            <div class="hover-effect">
                                <div class="hover-content">
                                    <ul class="social-icons">
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-12">
                    <div class="owl-clients owl-carousel">
                        <div class="client-item">
                            <img src="{{ asset('assets/images/client01.png')}}" alt="1">
                        </div>

                        <div class="client-item">
                            <img src="{{ asset('assets/images/client01.png')}}" alt="2">
                        </div>

                        <div class="client-item">
                            <img src="{{ asset('assets/images/client01.png')}}" alt="3">
                        </div>

                        <div class="client-item">
                            <img src="{{ asset('assets/images/client01.png')}}" alt="4">
                        </div>

                        <div class="client-item">
                            <img src="{{ asset('assets/images/client01.png')}}" alt="5">
                        </div>

                        <div class="client-item">
                            <img src="{{ asset('assets/images/client01.png')}}" alt="6">
                        </div>
                    </div>
                </div>
            </div>
